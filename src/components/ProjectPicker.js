      ...
      <div className="flex flex-col flex-no-wrap items-start my-3 overflow-x-scroll scrolling-touch md:items-center md:flex-row new-scrollbar">
        {projects.map((proj, i) => {
          return (
            <div
              key={i}
              className="flex-none w-64 py-12 m-5 4k:w-80 md:w-72 h-80 4k:h-fit card"
            >
              <p className="block h-12 font-bold 4k:h-32 4k:text-4xl">
                {proj.name}
              </p>
              ...
              {proj.deployed ? (
                <>
                  <div className="inline-block 4k:text-2xl">
                    ...
                    <a
                      className="inline-block font-bold align-middle links"
                      href={proj.url[0]}
                    >
                      Live Site
                    </a>
