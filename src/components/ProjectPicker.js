...
export default function ProjectPicker() {
    return (
          <div className="relative flex flex-col w-3/4 m-auto top-24">
            ...
            <div className="flex flex-col flex-no-wrap items-start items-center my-3 overflow-x-scroll scrolling-touch md:flex-row new-scrollbar">
              {projects.map((proj) => {
                 return (
                    <div className="flex-none w-64 py-12 m-5 md:w-72 h-72 card">
